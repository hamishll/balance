...
export default function BlobCard({ children, icon }) {
  return (
    <div className="flex flex-row relative overflow-hidden rounded-2xl w-[320px] shadow-xl dark:bg-black dark:bg-opacity-25 dark:shadow-none snap-start shrink-0 mt-4 border-[1px] border-blue-600/10 0">
